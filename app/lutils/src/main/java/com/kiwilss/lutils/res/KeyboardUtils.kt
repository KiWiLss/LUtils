...
object KeyboardUtils {
     ...
     */
    fun showSoftInput() {
        val imm = LUtilsConfig.getContext().getSystemService(Context.INPUT_METHOD_SERVICE) as InputMethodManager ?: return
        imm.toggleSoftInput(
    ...
    fun showSoftInput(view: View, flags: Int) {
        val imm =
            LUtilsConfig.getContext().getSystemService(Context.INPUT_METHOD_SERVICE) as InputMethodManager ?: return
    ...
    private fun getDecorViewInvisibleHeight(window: Window): Int {
        ...
        if (delta <= UtilsBridge.navBarHeight + UtilsBridge.statusBarHeight) {
    ...
    private fun getContentViewInvisibleHeight(window: Window): Int {
        ...
        return if (delta <= UtilsBridge.statusBarHeight + UtilsBridge.navBarHeight) {
            0
        } else delta
    }
